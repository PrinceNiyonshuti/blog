<x-layout>
    <section class="py-8 max-w-4xl mx-auto">
        <h1 class="text-lg font-bold mb-8 pb-2 border-b">Edit Post : {{  $post->title  }}</h1>
        ...
        <div class="flex">
            ...
            <main class="flex-1">
                <form action="/admin/posts/{{ $post->id }}" method="POST" class="border border-gray-200 p-6 rounder-xl" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex mt-6">
                            <div class="flex-1">
                                <input class="border border-gray-400 p-2 w-full" type="file" name="thumbnail" id="thumbnail" value="{{ $post->thumbnail }}" >
                            </div>
                    ...
                    <div class="mb-6">
                        <button type="submit" class="bg-blue-500 text-white uppercase font-semibold text-xs py-2 px-10 rounded-2xl hover:bg-blue-700">Update</button>
                    </div>
